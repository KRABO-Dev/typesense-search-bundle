...
$GLOBALS['TL_LANG']['tl_settings']['krabo_typesense_enabled'] = ['Inschakelen Typesense', ''];
...
$GLOBALS['TL_LANG']['tl_settings']['krabo_typesense_port'] = ['Poort', ''];
...
$GLOBALS['TL_LANG']['tl_settings']['krabo_typesense_analytics_delete_after'] = ['Verwijder anayltics', 'In jaren'];